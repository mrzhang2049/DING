...
# 创建Notion客户端
client = NotionClient(email="hellozhangxf@qq.com",password="hellozhang9658")
# parent_page = client.da('Q3-48cfd817e7c04274a63464d454918f4d')




cv = client.get_record_data(id="4b37964c7ed74abba5e86bb256b74726")
...
print(client)
# 获取指定页面https://www.notion.so/Q3-48cfd817e7c04274a63464d454918f4d?pvs=4
page = client.get_block("https://www.notion.so/Q3-48cfd817e7c04274a63464d454918f4d?pvs=4")
# 创建一个新的数据库
database = page.children.add_new(notion.collection.Collection)

# 设置数据库的标题和视图
database.title = "My Database"
database.views.add_new(view_type="table")

# 添加数据库的属性
database.add_property(name="Name", type="title")
database.add_property(name="Age", type="number")
database.add_property(name="Email", type="email")
